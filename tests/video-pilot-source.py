...
result={'unrelatedInlineScriptsUnchanged':len(before)-2,'scoringEngineUnchanged':True,'standaloneMatModeUnchanged':True,'embeddingIdempotent':True,'releaseBuildLabel':'0.20.47'}
